...
class __$$NotLoadedImplCopyWithImpl<$Res>
    extends _$UsersStateCopyWithImpl<$Res, _$NotLoadedImpl>
...
class _$NotLoadedImpl implements _NotLoaded {
  const _$NotLoadedImpl(this.message);
  ...
  @override
  String toString() {
    return 'UsersState.notLoaded(message: $message)';
  }
...
abstract class _NotLoaded implements UsersState {
  const factory _NotLoaded(final String message) = _$NotLoadedImpl;
